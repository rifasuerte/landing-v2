...
export default function PaymentInstructionsModal({
  ...
  const copyAllData = () => {
    const allData = [
      `Cédula de identidad: ${paymentData.rif || 'N/A'}`,
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4" style={{ zIndex: 999999, position: 'fixed' }}>
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <h3 className="text-xl font-bold text-gray-900 mb-1.5">Realiza tu Pago</h3>
          ...
          <button
            onClick={copyAllData}
            className="w-full mb-4 px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-semibold text-sm transition-colors flex items-center justify-center gap-2"
          >
          ...
          <div className="space-y-3 mb-4">
            {paymentData.rif && (
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-semibold text-gray-900 text-sm truncate">{paymentData.rif}</p>
                </div>
                <button
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex-1 min-w-0">
                ...
                <p className="font-semibold text-gray-900 text-sm truncate">{paymentData.bank}</p>
              </div>
              <button
            ...
            {paymentData.phone && (
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-semibold text-gray-900 text-sm truncate">{paymentData.phone}</p>
                </div>
                <button
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div className="flex-1 min-w-0">
                ...
                <p className="font-semibold text-gray-900 text-sm truncate">{paymentData.amount} {paymentData.currency}</p>
              </div>
              <button
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            ...
            className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2.5 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-lg text-sm"
          >
            Reportar pago
          </button>
        </div>
